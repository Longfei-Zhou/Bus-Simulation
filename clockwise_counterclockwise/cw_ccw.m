...
bus_location = [0 10]; % Numbers are distance from first stop
...
subplot(1,1,1)
  ...
  saveas(gcf, ['cw_ccw_bus_' num2str(seed) '.png'])  
...
saveas(gcf, ['cw_ccw_stop_' num2str(seed) '.png'])

%% save

save(['cw_ccw_' num2str(seed)])
