...
bus = {cw_cw_cw_bus1 cw_cw_cw_bus2 cw_cw_cw_bus3;  
...
for k = 1:3
    ...
    threebus = (bus{k}.^2+bus{k+L}.^2+bus{k+2*L}.^2)./(bus{k}+bus{k+L}+bus{k+2*L});
    plot(t,threebus)
    hold on
...
legend({'cw cw cw','cw ccw cw', 'ccw ccw ccw'}, 'Location', 'southeast')
